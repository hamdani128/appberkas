          ...
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" action="<?= route_to('login') ?>" method="post">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" name="login"
                      class="form-control <?php if(session('errors.login')) : ?>is-invalid<?php endif ?> form-control-lg border-left-0"
                ...
                <?php else: ?>
                <div class="form-group">
                  <label for="exampleInputEmail"><?=lang('Auth.emailOrUsername')?></label>
                  <div class="input-group">
                    <div class="input-group-prepend bg-transparent">
                      <span class="input-group-text bg-transparent border-right-0">
                        <i class="mdi mdi-account-outline text-primary"></i>
                    ...
                    <input type="text" name="login"
                      class="form-control <?php if(session('errors.login')) : ?>is-invalid<?php endif ?> form-control-lg border-left-0"
                      id="exampleInputEmail" placeholder="<?=lang('Auth.emailOrUsername')?>">
                    <div class="invalid-feedback">
                      <?= session('errors.login') ?>
                    </div>
                  </div>
                ...
                <div class="my-3">
                  <!-- <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn"
                    href="/assets/index.html">LOGIN</a> -->
