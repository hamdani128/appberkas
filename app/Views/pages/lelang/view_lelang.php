        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <h4 class="card-title">Form Input Berkas Lelang</h4>
                    <p class="card-description">
                        Form Input Berkas Lelang
                    </p>
                    <form class="forms-sample" method="post" action="/lelang/save" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        ...
                        <table class="table table-bordered" id="lelang-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?= $row->pemenang; ?></td>
                                    <td><?= $row->retensi; ?></td>
                                    <td><a href="/lelang/download/<?= $row->id; ?>"><?= $row->file_name ?></a></td>
                                    <td class="template-demo">
                                        <a href="/lelang/delete/<?= $row->id; ?>" class="btn btn-md btn-danger btn-rounded"><i class="mdi mdi-delete-sweep"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                                <?php } else {  ?>
