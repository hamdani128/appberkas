        ...
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <h4 class="card-title">Form Input Berkas HSE Plan</h4>
                    <p class="card-description">
                        Form Input Berkas HSE Plan
                    </p>
                    <form class="forms-sample" method="post" action="/hse/save" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
